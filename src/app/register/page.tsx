...
import { GraduationCap, Mail, Lock, ArrowLeft, User, Phone, BookOpen, Check } from "lucide-react";
                        ...
                        >
                                ...
                                <div className="bg-white p-8 md:p-12 rounded-[32px] border border-gray-100 shadow-2xl shadow-primary/5">
                                        <div className="text-center mb-10">
                                                ...
                                                <h1 className="text-2xl font-bold mb-2">Bắt đầu dùng thử 14 ngày</h1>
                                                <p className="text-secondary text-sm">Trải nghiệm đầy đủ tính năng, không cần thẻ tín dụng</p>
                                        </div>
                                                ...
                                                <div className="pt-2">
                                                        <div className="flex items-start gap-3 mb-6 ml-1">
                                                                ...
                                                                <label htmlFor="terms" className="text-xs text-secondary leading-relaxed">
                                                                        Tôi đồng ý với <Link href="#" className="font-bold text-primary hover:underline">Điều khoản dịch vụ</Link> và <Link href="#" className="font-bold text-primary hover:underline">Chính sách bảo mật</Link> của EduScale.
                                                                </label>
                                                        </div>
                                        ...
                                        <p className="text-center mt-10 text-sm text-secondary">
                                                Đã có tài khoản? <Link href="/login" className="font-bold text-primary hover:underline">Đăng nhập ngay</Link>
                                        </p>
                                </div>
                        </motion.div>
                </main>
