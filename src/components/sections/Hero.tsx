                        ...
                        <div className="container mx-auto px-4 md:px-6">
                                <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                                        ...
                                        <motion.div
                                                ...
                                                className="inline-flex items-center gap-2 bg-primary/5 border border-primary/10 px-4 py-2 rounded-full mb-8"
                                        >
                                                <div className="flex items-center -space-x-1">
                                                        {[1, 2, 3].map((i) => (
                                                                <div key={i} className="w-5 h-5 rounded-full bg-primary border-2 border-white" />
                                                        ))}
                                                </div>
                                        ...
                                        <motion.h1
                                                ...
                                                className="text-4xl md:text-6xl lg:text-7xl font-bold font-heading leading-[1.1] mb-8"
                                        >
                                                Nâng tầm quản lý <br />
                                        ...
                                        <motion.div
                                                ...
                                                className="relative w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl border-8 border-white/50 glass shadow-black/10"
                                        >
                                                <Image
