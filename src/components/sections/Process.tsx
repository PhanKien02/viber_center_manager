...
const steps = [
  {
    title: "Đăng ký nhanh",
    description:
      "Khởi tạo tài khoản chỉ trong 30 giây với các thông tin cơ bản của trung tâm.",
    icon: UserPlus,
  },
  {
    title: "Thiết lập trung tâm",
    description:
      "Nhập danh sách lớp, giáo viên và cài đặt các biểu phí thu học phí.",
    icon: ClipboardCheck,
  },
  {
    title: "Dữ liệu thông minh",
    description:
      "Sử dụng công cụ import dữ liệu học sinh hàng loạt để tiết kiệm thời gian.",
    icon: Zap,
  },
  {
    title: "Vận hành bứt phá",
    description:
      "Bắt đầu trải nghiệm sự thay đổi trong cách quản lý chuyên nghiệp hơn.",
    icon: Rocket,
  },
];
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {steps.map((step, index) => (
              <div
                key={index}
                className="relative z-10 text-center animate-in zoom-in-95 duration-500 fill-mode-both"
