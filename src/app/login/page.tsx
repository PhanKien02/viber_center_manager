...
import { GraduationCap, Mail, Lock, ArrowLeft, Chrome, Github } from "lucide-react";
                        ...
                        >
                                ...
                                <div className="bg-white p-8 md:p-10 rounded-[32px] border border-gray-100 shadow-2xl shadow-primary/5">
                                        <div className="text-center mb-10">
                                                ...
                                                <p className="text-secondary text-sm">Vui lòng đăng nhập để quản lý trung tâm của bạn</p>
                                        </div>
                                        ...
                                        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                                                ...
                                                <button
                                                        onClick={() => window.location.href = '/app/demo-center/dashboard'}
                                        ...
                                        <div className="relative my-8 text-center">
                                                ...
                                                <span className="relative px-4 bg-white text-xs text-secondary font-medium uppercase tracking-wider">Hoặc đăng nhập với</span>
                                        </div>
                                        ...
                                        <p className="text-center mt-10 text-sm text-secondary">
                                                Chưa có tài khoản? <Link href="/register" className="font-bold text-primary hover:underline">Đăng ký dùng thử</Link>
                                        </p>
                                </div>
                        </motion.div>
                </main>
