              ...
              <>
                {isProfileOpen && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 mt-3 w-64 bg-white rounded-3xl shadow-2xl border border-slate-100 p-2 z-20 animate-in fade-in zoom-in-95 duration-200">
                      <div className="p-4 border-b border-slate-50 mb-2">
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">
                          Hệ thống trung tâm
                        </p>
                        <p className="text-sm font-bold text-slate-900 capitalize">
                          {centerSlug.replace(/-/g, " ")}
                        </p>
                      </div>
        ...
        <section className="lg:col-span-8 order-2 lg:order-1 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-secondary text-sm">
                Chào mừng trở lại! Bạn đang quản lý các cơ sở thuộc hệ thống
                trung tâm{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {branches.map((branch) => (
              <div
                key={branch.id}
                className="bg-white rounded-[32px] p-6 border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all group relative animate-in fade-in slide-in-from-bottom-2 duration-300"
              >
                ...
                <Link
                  ...
                  className="w-full bg-slate-50 hover:bg-primary-600  text-primary py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 transition-all group/btn border border-primary/10 hover:border-transparent active:scale-[0.98]"
                >
                  Vào Dashboard Cơ sở
              ...
              {notifications.map((notif) => (
                <div key={notif.id} className="group cursor-pointer">
                  <div className="flex gap-4 p-3 rounded-2xl hover:bg-slate-50 transition-colors">
                    ...
                    <div>
                      <h4 className="text-sm font-bold mb-0.5 group-hover:text-primary transition-colors">
                        {notif.title}
                      </h4>
                      <p className="text-xs text-secondary leading-snug mb-1 line-clamp-2">
                        {notif.desc}
                      </p>
      ...
      <>
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            />
            <div className="relative w-full max-w-[500px] bg-white rounded-[32px] p-8 md:p-10 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-300">
