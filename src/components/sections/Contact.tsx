                                ...
                                <div className="flex flex-col lg:flex-row gap-16 items-start">
                                        ...
                                        <div className="w-full lg:w-1/3">
                                                ...
                                                <p className="text-secondary text-lg mb-8">
                                                        Chúng tôi luôn ở đây để hỗ trợ bạn. Hãy để lại thông tin hoặc liên hệ trực tiếp qua các kênh dưới đây.
                                                </p>
                                                ...
                                                <div className="space-y-6">
                                                        <div className="flex items-center gap-4">
                                                                ...
                                                                <div>
                                                                        <p className="text-sm text-secondary font-medium">Hotline 24/7</p>
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                                ...
                                                                <div>
                                                                        <p className="text-sm text-secondary font-medium">Email hỗ trợ</p>
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                                ...
                                                                <div>
                                                                        <p className="text-sm text-secondary font-medium">Địa chỉ trụ sở</p>
                                        ...
                                        <motion.div
                                                ...
                                                viewport={{ once: true }}
                                                className="w-full lg:w-2/3 bg-muted/30 p-8 md:p-12 rounded-3xl border border-muted"
                                        >
                                                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        ...
                                                        <div className="md:col-span-2 space-y-2">
                                                                <label className="text-sm font-bold ml-1">Nội dung tư vấn</label>
                                                                <textarea
                                                                        rows={4}
