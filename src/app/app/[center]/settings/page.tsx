        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 h-16 md:h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-secondary uppercase font-bold tracking-widest leading-none">
                Cấu hình trung tâm{" "}
                <span className="text-primary">{centerSlug}</span>
              </p>
            </div>
          </div>
          <button
            onClick={handleSave}
            className={`px-8 py-3.5 rounded-2xl font-bold flex items-center gap-2 shadow-lg transition-all active:scale-95 ${
              isSaving
          ...
          {[
            {
              ...
              icon: Building2,
              desc: "Tên, Logo, Địa chỉ",
            },
            {
              id: "branding",
              label: "Thương hiệu & Giao diện",
              icon: Palette,
              desc: "Màu sắc, Font chữ",
            },
            {
              id: "localization",
              label: "Vùng & Ngôn ngữ",
            ...
            },
            {
              ...
              icon: CreditCard,
              desc: "Cổng thanh toán, VAT",
            },
            {
              id: "roles",
              label: "Phân quyền & Bảo mật",
              icon: ShieldCheck,
              desc: "Admin, Giáo viên",
            },
            {
              id: "backup",
              label: "Dữ liệu & Sao lưu",
              icon: Database,
              desc: "Export, Import, Cloud",
            },
          ].map((item) => (
            <button
              key={item.id}
              onClick={() => setActiveSection(item.id)}
              className={`flex items-center gap-4 p-5 rounded-[28px] text-left transition-all border-2 ${
            ...
            >
              ...
              <div>
                <p
                  className={`font-bold text-sm ${activeSection === item.id ? "text-slate-900" : "text-slate-500"}`}
                >
                  {item.label}
                </p>
                ...
                <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <div>
                    ...
                    <p className="text-slate-500">
                      Cấu hình thông tin cơ bản của hệ thống trung tâm đào tạo
                      của bạn.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          />
                          <span className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-300 font-bold text-sm">
                            app /
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col items-center justify-center p-8 bg-slate-50 rounded-[32px] border-2 border-dashed border-slate-200 group hover:border-primary transition-colors cursor-pointer">
                      ...
                      <p className="text-xs font-bold text-slate-500 mb-1 group-hover:text-primary transition-colors">
                        Tải lên Logo trung tâm
                      </p>
                      <p className="text-[10px] text-slate-400">
                        Khuyến nghị: 512x512px, định dạng PNG
                      </p>
                    </div>
                  </div>
              ...
              {activeSection === "branding" && (
                <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <div>
                    ...
                    <p className="text-slate-500">
                      Tùy chỉnh màu sắc cá nhân hóa cho thương hiệu của bạn.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="bg-slate-900 rounded-[32px] p-8 text-white relative overflow-hidden group">
                      ...
                      <p className="mt-6 text-[10px] text-white/50 uppercase font-bold tracking-widest">
                        Xem trước giao diện
                      </p>
                    </div>
                  </div>
