...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="bg-primary hover:bg-primary-hover text-white px-5 py-2.5 rounded-full text-sm font-semibold shadow-lg shadow-primary/20 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer"
            >
              Dùng thử miễn phí
            </Link>
          </div>
      ...
      <>
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t mt-3 overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300">
            <div className="flex flex-col p-4 gap-4">
              ...
              <div className="flex flex-col gap-3 pt-2">
                <Link
                  href="/login"
                  className="w-full text-center py-3 font-semibold border rounded-xl"
                >
                  Đăng nhập
                </Link>
                <Link
