    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b sticky top-0 z-30">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 h-16 md:h-20 flex items-center justify-between">
          ...
          <button
            onClick={handleSave}
            className={`px-8 py-3 rounded-2xl font-bold flex items-center gap-2 shadow-lg transition-all active:scale-95 ${
              isSaved
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                <div>
                  ...
                  <p className="text-sm text-secondary">
                    Cập nhật thông tin cá nhân của bạn để mọi người trong trung
                    tâm có thể liên lạc.
                  </p>
                </div>
            ...
            {activeTab === "security" && (
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                <div>
                  ...
                  <p className="text-sm text-secondary">
                    Thay đổi mật khẩu và quản lý các thiết bị đã đăng nhập.
                  </p>
                </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      >
                        ...
                        <span
                          className={`text-[10px] font-bold uppercase tracking-widest ${login.color}`}
                        >
                          {login.status}
                        </span>
                      </div>
